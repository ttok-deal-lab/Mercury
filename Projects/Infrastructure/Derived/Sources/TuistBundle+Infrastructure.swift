...
/// Since Infrastructure is a static framework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "Infrastructure_Infrastructure"
    ...
    fatalError("unable to find bundle named Infrastructure_Infrastructure")
}()
}
// MARK: - Objective-C Bundle Accessor
@objc
public class InfrastructureResources: NSObject {
