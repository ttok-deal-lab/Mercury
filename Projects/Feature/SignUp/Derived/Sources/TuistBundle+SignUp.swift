...
/// Since SignUp is a static framework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "SignUp_SignUp"
    var candidates = [
    ...
    fatalError("unable to find bundle named SignUp_SignUp")
}()
