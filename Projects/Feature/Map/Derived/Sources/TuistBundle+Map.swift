...
/// Since Map is a static framework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "Map_Map"
    var candidates = [
    ...
    fatalError("unable to find bundle named Map_Map")
}()
}// MARK: - Objective-C Bundle Accessor
@objc
public class MapResources: NSObject {
