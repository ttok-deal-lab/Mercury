...
/// Since Interest is a static framework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "Interest_Interest"
    var candidates = [
    ...
    fatalError("unable to find bundle named Interest_Interest")
}()
}// MARK: - Objective-C Bundle Accessor
@objc
public class InterestResources: NSObject {
