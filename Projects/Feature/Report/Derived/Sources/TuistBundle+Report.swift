...
/// Since Report is a static framework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "Report_Report"
    ...
    fatalError("unable to find bundle named Report_Report")
}()
}
// MARK: - Objective-C Bundle Accessor
@objc
public class ReportResources: NSObject {
