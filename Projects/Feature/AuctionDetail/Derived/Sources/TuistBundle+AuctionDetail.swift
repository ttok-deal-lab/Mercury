...
/// Since AuctionDetail is a static framework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "AuctionDetail_AuctionDetail"
    ...
    fatalError("unable to find bundle named AuctionDetail_AuctionDetail")
}()
}
// MARK: - Objective-C Bundle Accessor
@objc
public class AuctionDetailResources: NSObject {
