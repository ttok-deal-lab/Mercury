...
/// Since CustomSplash is a static framework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "CustomSplash_CustomSplash"
    ...
    fatalError("unable to find bundle named CustomSplash_CustomSplash")
}()
}
// MARK: - Objective-C Bundle Accessor
@objc
public class CustomSplashResources: NSObject {
