...
/// Since Comment is a static framework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "Comment_Comment"
    var candidates = [
    ...
    fatalError("unable to find bundle named Comment_Comment")
}()
}// MARK: - Objective-C Bundle Accessor
@objc
public class CommentResources: NSObject {
