...
/// Since AppFoundation is a static framework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "AppFoundation_AppFoundation"
    var candidates = [
    ...
    fatalError("unable to find bundle named AppFoundation_AppFoundation")
}()
}// MARK: - Objective-C Bundle Accessor
@objc
public class AppFoundationResources: NSObject {
