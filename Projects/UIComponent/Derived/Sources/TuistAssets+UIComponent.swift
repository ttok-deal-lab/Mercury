...
public enum Asset {
  public enum Colors {
    ...
    public static let gray100ButtonGrayDefault = ColorAsset(name: "Gray100ButtonGrayDefault")
    ...
    public static let primary150ButtonPrimaryPressed = ColorAsset(name: "Primary150ButtonPrimaryPressed")
    public static let primary200ButtonPrimaryDefault = ColorAsset(name: "Primary200ButtonPrimaryDefault")
    public static let primary400ButtonPrimaryDisabled = ColorAsset(name: "Primary400ButtonPrimaryDisabled")
    public static let shadow = ColorAsset(name: "Shadow")
    public static let gray10TextWhite = ColorAsset(name: "Gray10TextWhite")
    public static let gray300TextDisabled = ColorAsset(name: "Gray300TextDisabled")
    public static let gray400TextSubText = ColorAsset(name: "Gray400TextSubText")
    public static let gray700TextDefault = ColorAsset(name: "Gray700TextDefault")
    public static let gray900TextBlack = ColorAsset(name: "Gray900TextBlack")
